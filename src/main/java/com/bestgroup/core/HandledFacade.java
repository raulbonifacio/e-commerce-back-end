...
@Stateless
public abstract class HandledFacade implements Facade {
	...
	public Result perform(Operation operation, DomainEntity entity) throws FacadeException, HandlerException {
	...
	public void onOperation(Operation operation, Class<? extends DomainEntity> entityClass, Handler handler) {
